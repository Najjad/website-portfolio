...
const Main = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let steps = [
    {
      ...
      description: "le skibidi rizz"
    },
    {
      name: "WebForgerStudio",
      icon: "fa-solid fa-list-check",
      description: "smegma smegma smegma"
    },
    {
      name: "PROJECT_TITLE",
      icon: "fa-solid fa-diagram-project",
      description: "here is how to jelq"
    }
  ];
  let benefits = [
    {
  ...
  return `<main class="flex flex-col flex-1 p-4"><section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14" data-svelte-h="svelte-1btowj6"><div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10"><h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">Hi! I&#39;m <span class="poppins text-violet-400">Najjad</span> Zeenni
    ...
    {
      step: steps[1],
      href: "https://github.com/WebForgerStudio"
    },
    {},
    {
      default: () => {
