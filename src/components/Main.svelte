    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Najjad</span> Zeenni
                <br />Full Stack
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> favorite techstacks</span> include Node.js + Express.js, MySQL, Java & Python!
            </p>
            <button
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-10">
            <Step step={steps[0]} href="https://github.com/Jaspero">
                <p>
                    Jaspero is a  <strong
                        ...
                        >javascript development agency</strong
            ...
            <Step step={steps[1]} href="https://github.com/WebForgerStudio">
                <p>
                    ...
                    >
                    <strong class="text-violet-400"></strong>is a small group of developers dedicated to creating cutting edge applications for web environments.
                </p>
            </Step>
        </div>
    </section>
